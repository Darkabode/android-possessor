...
import com.zer0.possessor.lzma.rangecoder.BitTreeDecoder;
import com.zer0.possessor.lzma.lz.OutWindow;
...
public class Decoder
{
	class LenDecoder
	{
		...
		public void Init()
		{
			com.zer0.possessor.lzma.rangecoder.Decoder.InitBitModels(m_Choice);
		...
		public int Decode(com.zer0.possessor.lzma.rangecoder.Decoder rangeDecoder, int posState) throws IOException
		{
	...
	class LiteralDecoder
	{
		class Decoder2
		{
			...
			public void Init()
			{
				com.zer0.possessor.lzma.rangecoder.Decoder.InitBitModels(m_Decoders);
			}
			
			public byte DecodeNormal(com.zer0.possessor.lzma.rangecoder.Decoder rangeDecoder) throws IOException
			{
				int symbol = 1;
				do
			...
			public byte DecodeWithMatchByte(com.zer0.possessor.lzma.rangecoder.Decoder rangeDecoder, byte matchByte) throws IOException
			{
				int symbol = 1;
				do
				{
	...
	com.zer0.possessor.lzma.rangecoder.Decoder m_RangeDecoder = new com.zer0.possessor.lzma.rangecoder.Decoder();
	...
	void Init() throws IOException
	{
		...
		com.zer0.possessor.lzma.rangecoder.Decoder.InitBitModels(m_IsMatchDecoders);
		com.zer0.possessor.lzma.rangecoder.Decoder.InitBitModels(m_IsRep0LongDecoders);
		com.zer0.possessor.lzma.rangecoder.Decoder.InitBitModels(m_IsRepDecoders);
		com.zer0.possessor.lzma.rangecoder.Decoder.InitBitModels(m_IsRepG0Decoders);
		com.zer0.possessor.lzma.rangecoder.Decoder.InitBitModels(m_IsRepG1Decoders);
		com.zer0.possessor.lzma.rangecoder.Decoder.InitBitModels(m_IsRepG2Decoders);
		com.zer0.possessor.lzma.rangecoder.Decoder.InitBitModels(m_PosDecoders);
